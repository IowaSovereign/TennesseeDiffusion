...
sync_apps() {
    ...
    if [ -z "${DISABLE_SYNC}" ]; then
        ...
        # Sync SD.Next to workspace to support Network volumes
        echo "Syncing SD_Next to workspace, please wait..."
        mv /SD_Next /workspace/SD_Next
...
fix_venvs() {
	...
	echo "Fixing SD_Next venv..."
    /fix_venv.sh /SD_Next/venv /workspace/SD_Next/venv
}
