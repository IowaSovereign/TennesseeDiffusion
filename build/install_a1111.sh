...
git clone https://github.com/AIrjen/OneButtonPrompt.git extensions/OneButtonPrompt
git clone https://github.com/Coyote-A/ultimate-upscale-for-automatic1111.git extensions/ultimate-upscale-for-automatic1111
git clone --depth=1 https://github.com/adieyal/sd-dynamic-prompts.git extensions/sd-dynamic-prompts
